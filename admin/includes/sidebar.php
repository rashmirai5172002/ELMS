     <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
                    ...
                    <li class="no-padding">
                        <a class="collapsible-header waves-effect waves-grey"><i class="material-icons">&#xe885</i>Holyday<i class="nav-drop-icon material-icons">keyboard_arrow_right</i></a>
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="addholyday.php">Add Holyday</a></li>
                                <li><a href="manageholyday.php">Manage Holyday</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="no-padding">
                    ...
                    <li class="no-padding">
                        ...
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li><a href="employeeholyday.php"> Employee Holyday</a></li>
                            </ul>
                        </div>
                    </li>
