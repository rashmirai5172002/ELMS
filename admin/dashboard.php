       ...
       <?php include('includes/sidebar.php');?>
            ...
            <main class="mn-inner mt-5">
                <div class="">
                    ...
                    <div class="col s12 m12 col-md-3 l4">
                    ...
                    <div class="col s12 m12 col-md-3 l4">
                        <div class="card stats-card border-0 shadow bg-dark">
                            <div class="card-content">
                                ...
                                <span class="card-title text-white">Total Holyday </span>
    <?php
$sql = "SELECT id from addholyday";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$date=$query->rowCount();
?>                            
                                <span class="stats-counter text-white"><span class="counter"><?php echo htmlentities($date);?></span></span>
                            </div>
                            <div id="sparkline-line"></div>
                        </div>
                    </div>
